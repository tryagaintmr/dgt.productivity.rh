...
export class AppSettings {
  ...
  public static addSiteEndpointUrl = '/_vti_bin/DgtServiceSharePoint/ServiceSharePoint.svc/CreateSite';
  public static deleteWebEndpointUrl = '/_vti_bin/DgtServiceSharePoint/ServiceSharePoint.svc/DeleteWeb';
  ...
  public static postponeWebEndpointUrl = '/_vti_bin/DgtServiceSharePoint/ServiceSharePoint.svc/PostponeSiteDeletion';
  public static getWebsEndpointUrl = '/_vti_bin/DgtServiceSharePoint/ServiceSharePoint.svc/GetAllWebs';
  public static getWebDetailEndpointUrl = '/_vti_bin/DgtServiceSharePoint/ServiceSharePoint.svc/GetWebDetail';
  public static getSitsEndpointUrl = '/_vti_bin/DgtServiceSharePoint/ServiceSharePoint.svc/CreateSite';
